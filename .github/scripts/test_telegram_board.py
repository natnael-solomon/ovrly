...
class RenderTest(unittest.TestCase):
    def test_board_sections_and_blocked(self):
        ...
        self.assertEqual(lines[3], '<blockquote><a href="https://github.com/o/r/issues/17">#17 Task 17 · unassigned</a></blockquote>')
        self.assertEqual(lines[4], "<b>In progress</b>")
        self.assertEqual(lines[5], '<blockquote><a href="https://github.com/o/r/issues/42">#42 share intake · dev</a></blockquote>')
        self.assertEqual(lines[6], "<b>Blocked</b>")
        self.assertEqual(lines[7], '<blockquote><a href="https://github.com/o/r/issues/33">#33 old &lt;spike&gt; · dev</a></blockquote>')
