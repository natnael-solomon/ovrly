...
class RenderTest(unittest.TestCase):
    def test_board_sections_and_blocked(self):
        ...
        self.assertEqual(lines[2], '<b>Ready</b>  <a href="https://github.com/o/r/issues/17">#17</a>')
        self.assertEqual(lines[3], "<blockquote>Task 17 · <i>unassigned</i></blockquote>")
        self.assertEqual(lines[4], "")
        self.assertEqual(lines[5], '<b>In progress</b>  <a href="https://github.com/o/r/issues/42">#42</a>')
        self.assertEqual(lines[6], "<blockquote>share intake · <i>dev</i></blockquote>")
        self.assertEqual(lines[8], '<b>Blocked</b>  <a href="https://github.com/o/r/issues/33">#33</a>')
        self.assertEqual(lines[9], "<blockquote>old &lt;spike&gt; · <i>dev</i></blockquote>")
        self.assertEqual(lines[10], "")
        self.assertTrue(lines[11].startswith('<tg-time unix="1700000000" format="r">'))
    ...
    def test_changes_group_by_transition(self):
        ...
        self.assertEqual(lines[2], '<code>Ready</code> <b>→</b> <code>In review</code>  <a href="https://github.com/o/r/issues/1">#1</a>  <a href="https://github.com/o/r/issues/3">#3</a>')
        self.assertEqual(lines[3], "<blockquote>Task 1 · <i>dev</i></blockquote>")
        self.assertEqual(lines[4], "<blockquote>Task 3 · <i>dev</i></blockquote>")
        self.assertEqual(lines[5], "")
        self.assertEqual(lines[6], '<b>Priority</b> <code>Next</code> <b>→</b> <code>Now</code>  <a href="https://github.com/o/r/issues/1">#1</a>')
        self.assertEqual(lines[7], "<blockquote>Task 1 · <i>dev</i></blockquote>")
        self.assertEqual(lines[9], '<b>Area</b> — <b>→</b> <code>Android</code>  <a href="https://github.com/o/r/issues/1">#1</a>')
        self.assertEqual(lines[12], '<b>Added</b> —  <a href="https://github.com/o/r/issues/2">#2</a>')
        self.assertEqual(lines[13], "<blockquote>Task 2 · <i>unassigned</i></blockquote>")
        self.assertEqual(lines[15], '<b>Removed</b>  <a href="https://github.com/o/r/issues/4">#4</a>')
        self.assertEqual(lines[16], "<blockquote>Task 4</blockquote>")
